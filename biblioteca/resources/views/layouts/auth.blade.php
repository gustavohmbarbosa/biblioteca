<!DOCTYPE html>
<!-- saved from url=(0055)https://demo.pixelcave.com/codebase/op_auth_signin2.php -->
<html lang="{{ config('app.locale') }}" class="no-focus"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        IN THE FULL VERSION
            ...
            YOU GET THE GET STARTED VERSION!
        ...
        ** A LICENSE MUST BE ACQUIRED FOR LEGAL USE -> LINK: https://1.envato.market/95j **
