...
<template>
  <div id="page-user-edit">
    ...
    <vs-alert color="danger" title="User Not Found" :active.sync="user_not_found">
      <span>Reader record with id: {{ $route.params.userId }} not found. </span>
      <span>
        <span>Check </span><router-link :to="{name:'page-reader-list'}" class="text-inherit underline">All Users</router-link>
      </span>
    </vs-alert>
