...
<template>
    <div class="h-screen flex w-full bg-img">
        <div class="vx-col flex items-center justify-center flex-col sm:w-1/2 md:w-3/5 lg:w-3/4 xl:w-1/2 mx-auto text-center">
            ...
            <p class="sm:mx-0 mx-4 mb-4 sm:mb-16 text-primary">Desculpe-nos, não conseguimos encontrar esta página ou ela não existe.</p>
            <vs-button size="large" to="/">Página Inicial</vs-button>
        </div>
    </div>
</template>
