      ...
      <vs-tab label="Livro" icon-pack="feather" icon="icon-book" class="mt-4">
            ...
            <template slot="append">
              <div class="append-text btn-addon">
                <vx-tooltip
                  delay=".5s"
                  position="right"
                  text="Busque as informações do livro pelo ISBN"
                >
                  <vs-button
                    color="primary"
                    icon-pack="feather"
          ...
          <vx-input-group>
            <template slot="prepend">
              <vx-tooltip
                delay=".5s"
                position="left"
                text="Cadastre uma nova editora"
              >
                <div class="prepend-text btn-addon">
                  <vs-button
                    color="primary"
        ...
        <div class="vx-col w-full mb-6 cape-container">
          <label class="flex">
            ...
            <vx-tooltip
              ...
              color=""
              text="Se você fez a busca do livro pelo ISBN talvez a imagem da capa esteja disponível para download neste link."
              position="right"
            >
              <a
                :href="book.linkCape"
        ...
        <div class="vx-col w-full">
          <vs-button
            ...
            >Cancelar</vs-button
          >
          <vs-button class="float-right" @click="activeTab = 1"
            >Avançar</vs-button
          >
        </div>
      </vs-tab>
      ...
      <vs-tab label="Biblioteca" icon-pack="feather" icon="icon-archive">
        ...
        <div class="vx-row">
          ...
          <div class="vx-col w-full mb-6 sm:w-1/2">
            ...
            <vs-input
              ...
              icon-no-border
              placeholder="Preço"
              v-model.lazy="book.price"
              :disabled="book.origin != 'Comprado'"
              v-money="money"
              maxlength="7"
            />
        ...
        <div class="w-full mb-6">
          ...
          <vs-textarea
            rows="5"
            counter="190"
            :counter-danger.sync="counterDanger[1]"
  ...
  methods: {
    ...
    checkCompanyToSet(companyName) {
      try {
        ...
        this.validations.company_id = [
          "Verifique se a editora deste livro ja foi cadastrada."
        ];
      }
    },
